...
- [x] 05-02-PLAN.md -- Pipeline integration: resolver orchestrator, worker orchestrator AI step, evaluation harness comparison (deterministic vs AI F1), Docker env config
